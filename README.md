...
- It additionally redistributes **[Living Characters](https://github.com/LivingNarratives/LivingCharacters) v2.59c by LivingNarratives** (MIT — see [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md); their GitHub is the source of truth for standalone use) and **[SlowBurn](https://github.com/saya-evrlc/Slowburn) by saya-evrlc**, included unmodified — their GitHub is the source of truth for standalone use. No license is published upstream; bundled with credit, removed on the author's request.
- Community: **ShotRush** — engine contributor. The creator-specified trackers idea seeded the ParaWorld package (StateKit + TrackerKit), and his character auto-registration sketch is prior art for the BridgeKit research subject (see ROADMAP).
